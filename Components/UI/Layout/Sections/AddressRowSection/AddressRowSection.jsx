...
import styles from "./AddressRowSection.module.scss";
import CustomAccordion from "@/Components/UI/Accordion/CustomAccordion";
export default function AddressRowSection({
  title,
  subtitle,
  description,
  imageAlignment,
      ...
      <Container maxWidth="xl">
        <div className={`${styles.wrapper}`}>
          ...
          >
            ...
            <Typography variant="h4" component="h2" className={`${styles.title} mt-8`} >
              {title}
            </Typography>

            <div
              className={`${styles.description} heading-5 mb-16 mt-8`}
            ...
            {bulletPoints && bulletPoints?.length > 0 &&
              ...
              <div className={`${styles.addressContainer} mt-24 mb-24 border-radius-12`}>
                   <Typography variant="h6" component="div" className={`${styles.subtitle} subtitle`} >
              {addressSection.subtitle}
            </Typography>
            <Typography variant="h6" component="div" className={`${styles.title} mt-4 medium` } color={"var(--light-primary)"}>
              {addressSection.title}
            </Typography>
              <Typography variant="body1" component="p" className={`${styles.title} mt-8`} >
              {addressSection.description}
            </Typography>
                </div> 
