...
import LatestUpdatesSection from "@/Components/UI/Layout/Sections/LatestUpdatesSection/LatestUpdatesSection";
...
export default async function Home() {
  const [data, newsData, upcomingEventsData, options] = await Promise.all([
    getSinglePostData("homepage", "wp-json/wp/v2/pages"),
